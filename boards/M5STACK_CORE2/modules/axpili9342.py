...
class ili9XXX:
    ...
    def __init__(self,
        ...
        cs=13,
        dc=12,
        backlight=100, backlight_on=1, power_on=1,
...
class ili9341(ili9XXX):
    ...
    def __init__(self, m5stack=M5Stack(), 
        mosi=23, miso=38, clk=18, dc=15, cs=5, backlight=100, backlight_on=1, power_on=0,
        spihost=esp.HSPI_HOST, mhz=40, factor=4, hybrid=True, width=320, height=240, start_x=0, start_y=0,
        colormode=COLOR_MODE_BGR, rot=0x10, invert=True, double_buffer=True, half_duplex=True,
        ...
        super().__init__(m5stack=m5stack, miso=miso, mosi=mosi, clk=clk, cs=cs, dc=dc,  backlight=backlight,
